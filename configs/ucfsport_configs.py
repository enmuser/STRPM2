...
parser.add_argument('--data_train_path', type=str, default='datasets/ucfsports/train.txt')
parser.add_argument('--data_val_path', type=str, default='datasets/ucfsports/test.txt')
...
parser.add_argument('--save_dir', type=str, default='checkpoints/ucfsport/')
